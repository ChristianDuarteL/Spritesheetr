    ...
    return (
        <div className="group p-2 rounded-md bg-accent-200 shadow-md flex flex-col gap-2 relative">
            <div className="aspect-square rounded-sm overflow-hidden bg-accent-50">
                <img className="w-full h-full object-contain render-pixelated" src={props.image.url}/>
            </div>
            ...
            <div className="opacity-0 transform translate-y-2 group-hover:translate-y-0 group-hover:opacity-100 focus-within:translate-y-0 focus-within:opacity-100 transition absolute -right-2 -top-2 rounded-full shadow-sm">
